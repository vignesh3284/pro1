...
$form['dashamount'] = array(
	'#type' => 'textfield',
	'#title' => 'Enter the dashboard total amount',
	'#size' => '90',
	'#required' => true,	
	 '#default_value' => $config->get('dashamount'),
	'#description' => 'Enter the name of the payment gateway response table to be used');
$dashboardamount  = $config->get('dashamount');
...
$config->set('dashamount', $form_state->getValue('dashamount'));
